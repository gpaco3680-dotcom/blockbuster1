...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h2 class="mb-4">Crear Nuevo Género</h2>

            <form action="<?php echo base_url('/admin/generos'); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descripcion_genero" name="descripcion_genero" rows="4"></textarea>
                </div>
