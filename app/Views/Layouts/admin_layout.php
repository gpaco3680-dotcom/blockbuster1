...
<head>
    ...
    <title><?= $this->renderSection('title') ?>Blockbuster | Panel Administrativo</title>
        ...
        <div class="col-md-3 col-lg-2">
            <div class="sidebar">
                <div class="user-section text-center">
                    ...
                    <p class="mt-2 mb-0 fw-bold">Administrador</p>
                </div>

                <nav class="nav flex-column">
                    <a class="nav-link <?= (strpos(current_url(), '/admin/usuarios') !== false) ? 'active' : '' ?>" href="/admin/usuarios">
                        <i class="fas fa-users"></i> Usuarios
                    </a>
                    <a class="nav-link <?= (strpos(current_url(), '/admin/generos') !== false) ? 'active' : '' ?>" href="/admin/generos">
                        <i class="fas fa-tag"></i> Géneros
                    </a>
                    <a class="nav-link <?= (strpos(current_url(), '/admin/planes') !== false) ? 'active' : '' ?>" href="/admin/planes">
