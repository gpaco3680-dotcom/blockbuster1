-- Script SQL para configurar Blockbuster (Corregido para Evaluación Final UPTX)
...
-- Insertar usuarios de prueba (Manteniendo tus contraseñas encriptadas para CI4)
...
-- Insertar contenido de ejemplo adaptado a los tipos del PDF
...
-- 7. Crear tabla de videos (Mencionada en el PDF)
...
CREATE TABLE IF NOT EXISTS blockbuster_alquileres (
    ...
    estatus_alquiler TINYINT(1) DEFAULT 1, -- 1: En proceso, 2: Culminado, 3: Cancelado
...
SELECT 'Base de datos Blockbuster configurada y 100% alineada al PDF!' as mensaje;